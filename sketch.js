...
function setup() {
	...
	roofObject=new Roof(300,190,400,30);

	bobDiameter=60;

	var p1=width/2;
	var p2=height/4+500;
	bob1=new Ball(260,400,60);
	bob2=new Ball(330,400,60);
	bob3=new Ball(390,400,60);
	bob4=new Ball(450,400,60);
	bob5=new Ball(510,400,60);
